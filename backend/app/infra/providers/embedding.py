...
class OpenAICompatibleEmbeddingProvider:
    """Embedding provider for OpenAI-compatible APIs (e.g. SiliconFlow, OpenAI)."""
    ...
    async def __aenter__(self) -> "OpenAICompatibleEmbeddingProvider":
        return self
                    ...
                    try:
                        ...
                        if len(items) != len(chunk):
                            raise ValueError(
                                ...
                                f"expected {len(chunk)}, got {len(items)}"
                            )
